<template>
  <div>
              ...
              <li v-for="item in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'checked':item.checked=='1'}"
                       @click="cartEdit('edit',item)">
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a href="javascipt:;" class="input-sub" @click="cartEdit('minu',item)">-</a>
                        <span class="select-ipt">{{item.productNum}}</span>
                        <a href="javascipt:;" class="input-add" @click="cartEdit('add',item)">+</a>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" v-bind:class="{'btn--dis':checkAllCount==0}" @click="checkout">Checkout</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <model :mdShow="modalConfirm" v-on:close="closeModal">
...
<script>
  ...
  export default {
    ...
    computed: {
      checkAllFlag() {
        return this.checkAllCount == this.cartList.length
      },
      checkAllCount() {
        var i = 0;
