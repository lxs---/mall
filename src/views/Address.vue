<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':index==checkIndex}"
    ...
    <Model :mdShow="isMdShow" v-on:close="closeModal">
      <span slot="message">确定要删除这条地址吗？</span>
      <div slot="btnGroup">
