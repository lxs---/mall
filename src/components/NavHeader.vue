    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" @click="logOut" v-if="nickName">Logout</a>
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="errorTips">用户名或者密码错误</span>
            </div>
            <ul>
    ...
    methods: {
      ...
      getCartCount() {
        axios.get('/users/getCartCount').then(response => {
          this.$store.commit('updateCartCount', response.data.result)
        })
      }
    }
  }
